...
**ReLu universal approximation theorem?**
...
[14]*   : Avg pooling
[15]    : [DONE] list for activation fn of each layers
...
step        = filter_size//2
filter_count= 4                         #number of filters per conv layer
...
topology    = np.array([inp_vector,1024,512,nodes_output])          #number of hidden layers and units in each
